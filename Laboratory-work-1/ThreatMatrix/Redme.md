...
|Дані: <br> - системні (конфігураційні файли ОС та прикладного ПЗ) <br> - прикладні дані (файли та база даних), які є результатом роботи прикладного ПЗ|- Завантаження продукту з невідомих джерел (психологічний фактор через те що багато людей використовують свої справжні паролі та пошти що може потрапити до рук зловмисника|- Запуск невідомих (шкідливих) файлів|- Зміна конфігураційних файлів може привести до втрати доступа|
